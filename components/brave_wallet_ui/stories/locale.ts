...
provideStrings({
  ...
  braveWalletTransactionPartnerConsent:
    ...
    'crypto providers for your region. Some of your information will be ' +
    'shared with Meld.io to complete the transaction. For more information ' +
    'please read Meld’s terms of use.',
