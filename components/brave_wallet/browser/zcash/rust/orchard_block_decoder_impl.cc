...
std::unique_ptr<OrchardDecodedBlocksBundle>
OrchardBlockDecoderImpl::ScanBlocks(
  ...
  chain_state.frontier_block_height = frontier_chain_state.frontier_block_height;
  chain_state.frontier_orchard_commitment_tree_size = frontier_chain_state.frontier_orchard_tree_size;
